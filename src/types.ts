...
export interface User {
  ...
  title?: string; // คำนำหน้าชื่อ (นาย/นางสาว/นาง/ยศอื่น ๆ)
  titleEn?: string; // English Title
  firstName?: string; // English First Name
  lastName?: string; // English Last Name
  firstNameTh?: string; // ชื่อจริงภาษาไทย
  ...
  languagePreference?: 'TH' | 'EN'; // Language preference for student card
}
...
export interface BorrowRecord {
  ...
  purpose?: string; // วัตถุประสงค์การยืม (เช่น JOB Card No.)
  returnDate?: string;
